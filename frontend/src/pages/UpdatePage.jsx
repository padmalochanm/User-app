...
const UpdatePage = () => {
    ...
    const [formData, setFormData] = useState({
        ...
        available: userData ? userData.available : false,
      });
  ...
  useEffect(() => {
    async function fetchUserData() {
      try {
        ...
        const dataResponse = await axios.get(`/api/users/${userData.id}`);
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    try {
      await axios.put(`/api/users/${userData.id}`, formData, {headers: {
